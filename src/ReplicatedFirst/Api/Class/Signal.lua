...
function Signal.new()
    local self = setmetatable({_handlerListHead = false, _proxyHandler = nil},
                              Signal)
    return self
end
...
function Signal.Wrap(rbxScriptSignal)
    assert(typeof(rbxScriptSignal) == "RBXScriptSignal",
...
function Signal:Destroy()
    ...
    if proxyHandler then proxyHandler:Disconnect() end
end
